...

{
  ...
  $Id: Struct.pas,v 1.28 2001/04/23 15:50:48 jr Exp $
}
...
const
  ...
  SetupVersion = '2.0.8-dev'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (2 shl 24) + (0 shl 16) + (8 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (2.0.8)';
