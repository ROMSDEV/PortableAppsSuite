...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.68 2003/05/12 05:30:11 jr Exp $
}
...
const
  ...
  SetupVersion = '4.0.1-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (0 shl 16) + (1 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.0.1)';
