...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.210 2007/07/22 21:17:07 jr Exp $
}
...
const
  ...
  SetupVersion = '5.1.13';
  SetupBinVersion = (5 shl 24) + (1 shl 16) + (13 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.1.13)';
