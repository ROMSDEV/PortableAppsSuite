...

{
  ...
  $Id: Struct.pas,v 1.54 2002/10/20 17:23:38 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.4-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (4 shl 8) + 0;
