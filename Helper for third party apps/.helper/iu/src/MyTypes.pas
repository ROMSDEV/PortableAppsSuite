...
type
  ...
  TMySetupHeader = record // in-memory only
    AppName, AppVerName, AppId, AppCopyright, AppPublisher, AppPublisherURL,
      ...
      UninstallDisplayIcon, AppMutex, AppReadmeFile, AppContact, AppComments,
      AppModifyPath, CreateUninstallRegKey, Uninstallable,
      CloseApplicationsFilter, SetupMutex: AnsiString;
...
type
  ...
  public
    ...
    IsUnicode:boolean;
    IsRT:boolean;
    SetupID:array[1..12] of char; // other units have no access to global data in structXXXX.pas
...
function SetInteger64(Val: Cardinal) : Integer64; overload;
function SetInteger64(Val: Integer64) : Integer64; overload;
...
function SetInteger64(Val: Cardinal) : Integer64;
begin
  Result.Lo := Val;
  Result.Hi := 0;
end;

function SetInteger64(Val: Integer64) : Integer64;
begin
  Result := Val;
end;
