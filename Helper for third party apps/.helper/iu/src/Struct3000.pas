...

{
  ...
  $Id: Struct.pas,v 1.46 2002/02/17 22:46:53 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.0-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (0 shl 8) + 2;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (3.0.0a)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (3.0.0)';
