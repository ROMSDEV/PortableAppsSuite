...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.216 2007/09/19 19:29:06 jr Exp $
}
...
const
  ...
  SetupVersion = '5.2.0';
  SetupBinVersion = (5 shl 24) + (2 shl 16) + (0 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.2.0)';
