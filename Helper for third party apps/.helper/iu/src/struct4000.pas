...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.63 2003/04/14 18:53:12 jr Exp $
}
...
const
  ...
  SetupVersion = '4.0.0-dev'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (0 shl 16) + (0 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.0.0a)';
...
type
  ...
  TSetupLanguageEntry = packed record
    Name, LanguageName, DialogFontName, TitleFontName, WelcomeFontName,
      CopyrightFontName, Data: AnsiString;
    LanguageID: Cardinal;
...
const
  ...
  SetupLdrOffsetTableID = 'rDlPtS04'#$87#$65#$56#$78;
