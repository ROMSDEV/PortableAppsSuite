...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.119 2004/02/25 22:59:42 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.8'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (8 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.8)';
