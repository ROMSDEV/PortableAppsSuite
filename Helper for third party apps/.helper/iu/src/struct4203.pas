...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.135 2004/05/20 17:15:59 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.3'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (3 shl 8) + 0;
