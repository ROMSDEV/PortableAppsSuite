...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.147 2004/06/19 19:34:26 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.6'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (6 shl 8) + 0;
