...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.104 2004/01/28 09:36:03 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.3'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (3 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.3)';
