...

{
  ...
  $Id: Struct.pas,v 1.51 2002/06/01 20:33:25 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.2-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (2 shl 8) + 0;
...
const
  ...
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (3.0.2)';
