...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.129 2004/04/02 18:29:38 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.1'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (1 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.2.1)';
