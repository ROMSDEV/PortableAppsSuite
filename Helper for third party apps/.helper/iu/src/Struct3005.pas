...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.60 2002/12/16 07:40:49 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.5'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (5 shl 8) + 0;
