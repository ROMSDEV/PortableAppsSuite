...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.69 2003/05/16 19:35:04 jr Exp $
}
...
const
  ...
  SetupVersion = '4.0.2-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (0 shl 16) + (2 shl 8) + 0;
