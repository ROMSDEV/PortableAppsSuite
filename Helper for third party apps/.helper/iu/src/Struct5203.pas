...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.222 2008/03/10 23:55:31 jr Exp $
}
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.2.3)';
  UninstallLogID: array[Boolean] of TUninstallLogID =
    ('Inno Setup Uninstall Log (b)', 'Inno Setup Uninstall Log (b) 64-bit');
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (5.1.11)';
...
type
  TSetupHeader = packed record
    AppName, AppVerName, AppId, AppCopyright, AppPublisher, AppPublisherURL,
      ...
      SignedUninstallerSignature: AnsiString;
