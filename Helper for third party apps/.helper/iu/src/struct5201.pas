...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.218 2007/10/13 19:04:09 jr Exp $
}
...
const
  ...
  SetupVersion = '5.2.1';
  SetupBinVersion = (5 shl 24) + (2 shl 16) + (1 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.2.1)';
