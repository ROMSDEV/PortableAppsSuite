...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.101 2004/01/22 03:00:23 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.1'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (1 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.0)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (4.1.1)';
