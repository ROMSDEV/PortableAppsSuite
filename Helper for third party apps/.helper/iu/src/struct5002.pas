...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.158 2004/08/05 21:12:34 jr Exp $
}
...
const
  ...
  SetupVersion = '5.0.2-beta';
  SetupBinVersion = (5 shl 24) + (0 shl 16) + (2 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.0.1)';
