...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.147.2.1 2004/06/27 06:38:58 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.7'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (7 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.2.6)';
