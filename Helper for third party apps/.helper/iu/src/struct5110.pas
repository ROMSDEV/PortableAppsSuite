...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.201 2007/02/17 23:53:17 jr Exp $
}
...
const
  ...
  SetupVersion = '5.1.10';
  SetupBinVersion = (5 shl 24) + (1 shl 16) + (10 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.1.10)';
