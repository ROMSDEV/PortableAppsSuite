...

{
  ...
  $Id: Struct.pas,v 1.26 2001/04/13 23:54:52 mlaan Exp $
}
...
const
  ...
  SetupVersion = '2.0.7-dev'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (2 shl 24) + (0 shl 16) + (7 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (2.0.7)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (2.0.3)';
