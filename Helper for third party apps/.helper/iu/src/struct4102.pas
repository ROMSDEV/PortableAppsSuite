...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.103 2004/01/24 20:44:01 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.2'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (2 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.2)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (4.1.2)';
