...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.144 2004/06/15 02:13:07 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.5'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (5 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.2.5)';
