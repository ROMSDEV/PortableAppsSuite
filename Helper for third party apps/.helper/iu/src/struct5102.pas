...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.186 2005/04/14 19:21:43 jr Exp $
}
...
const
  ...
  SetupVersion = '5.1.2-beta';
  SetupBinVersion = (5 shl 24) + (1 shl 16) + (2 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.1.2)';
