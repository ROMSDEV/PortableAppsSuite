...

{
  ...
  $Id: Struct.pas,v 1.49 2002/04/03 22:55:30 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.1-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (1 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (3.0.1)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (3.0.1)';
