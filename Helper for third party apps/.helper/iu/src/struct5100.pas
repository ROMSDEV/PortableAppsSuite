...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.178 2005/03/01 19:12:16 jr Exp $
}
...
const
  ...
  SetupVersion = '5.1.0-beta';
  SetupBinVersion = (5 shl 24) + (1 shl 16) + (0 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.1.0)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (5.1.0)';
...
type
  ...
  TSetupProcessorArchitecture = (paUnknown, paX86, paAMD64, paIA64);
...
type
  TSetupHeader = packed record
    AppName, AppVerName, AppId, AppCopyright, AppPublisher, AppPublisherURL,
      ...
      AppReadmeFile, AppContact, AppComments, AppModifyPath: AnsiString;
