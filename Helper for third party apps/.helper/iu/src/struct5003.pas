...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.161 2004/08/16 20:25:43 jr Exp $
}
...
const
  ...
  SetupVersion = '5.0.3-beta';
  SetupBinVersion = (5 shl 24) + (0 shl 16) + (3 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.0.3)';
