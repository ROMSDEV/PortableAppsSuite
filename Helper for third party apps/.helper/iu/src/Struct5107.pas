...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.196 2006/08/18 18:58:55 jr Exp $
}
...
const
  ...
  SetupVersion = '5.1.7';
  SetupBinVersion = (5 shl 24) + (1 shl 16) + (7 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.1.7)';
