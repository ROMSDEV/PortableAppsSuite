...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.115 2004/02/20 19:49:44 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.7'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (7 shl 8) + 0;
