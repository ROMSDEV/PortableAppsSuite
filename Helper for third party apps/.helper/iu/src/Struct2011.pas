...

{
  ...
  $Id: Struct.pas,v 1.35 2001/06/09 21:24:07 jr Exp $
}
...
const
  ...
  SetupVersion = '2.0.11'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (2 shl 24) + (0 shl 16) + (11 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (2.0.11)';
