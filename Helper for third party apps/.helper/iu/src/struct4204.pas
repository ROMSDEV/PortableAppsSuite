...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.138 2004/06/01 18:28:47 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.4'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (4 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.2.3)';
