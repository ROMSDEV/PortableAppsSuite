...

{
  ...
  $Id: Struct.pas,v 1.42 2001/11/09 22:32:46 jr Exp $
}
...
const
  ...
  SetupVersion = '2.0.17'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (2 shl 24) + (0 shl 16) + (17 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (2.0.17)';
