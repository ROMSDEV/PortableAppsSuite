...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.99 2004/01/17 00:29:43 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.0'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (0 shl 8) + 0;
