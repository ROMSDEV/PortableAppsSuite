...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.78 2003/09/22 02:36:16 jr Exp $
}
...
const
  ...
  SetupVersion = '4.0.8'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (0 shl 16) + (8 shl 8) + 0;
