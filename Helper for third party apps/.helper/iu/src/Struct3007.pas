...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.62.4.1 2003/04/14 20:01:00 jr Exp $
}
...
const
  ...
  SetupVersion = '3.0.7'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (3 shl 24) + (0 shl 16) + (7 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (3.0.5)';
