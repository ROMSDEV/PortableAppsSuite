...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.114 2004/02/19 06:48:50 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.6'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (6 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.6)';
