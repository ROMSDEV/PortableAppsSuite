...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.154 2004/07/14 20:02:07 jr Exp $
}
...
const
  ...
  SetupVersion = '5.0.0-beta'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (5 shl 24) + (0 shl 16) + (0 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.0.0)';
