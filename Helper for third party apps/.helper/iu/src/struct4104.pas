...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.107 2004/02/08 19:21:17 jr Exp $
}
...
const
  ...
  SetupVersion = '4.1.4'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (1 shl 16) + (4 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.1.4)';
