...

{
  ...
  $jrsoftware: issrc/Projects/Struct.pas,v 1.133 2004/04/27 18:59:35 jr Exp $
}
...
const
  ...
  SetupVersion = '4.2.2'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (4 shl 24) + (2 shl 16) + (2 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (4.2.2)';
