...

{
  ...
  $Id: Struct.pas,v 1.43.4.1 2002/02/10 18:29:48 jr Exp $
}
...
const
  ...
  SetupVersion = '2.0.18'  {$IFDEF USEBUILDTAG} {$I BuildTag.inc} {$ENDIF};
  SetupBinVersion = (2 shl 24) + (0 shl 16) + (18 shl 8) + 0;
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (2.0.18)';
  UninstallLogID: TUninstallLogID = 'Inno Setup Uninstall Log (b)';
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages (2.0.8)';
